...
try:
    adc0 = ADC(Pin('A0'))
    print("PASS: ADC init on A0")
except Exception as e:
    print("FAIL: ADC init on A0: {}".format(e))
...
try:
    ...
    print("ADC A0: raw={}, voltage={:.3f}V".format(raw, voltage))
    if 0 <= raw <= 65535:
...
try:
    ...
    print("ADC 10 samples: avg={:.0f}, spread={}".format(avg, spread))
    if spread < 5000:
...
# Test 4: Second ADC channel (A1)
try:
    adc1 = ADC(Pin('A1'))
    raw1 = adc1.read_u16()
    voltage1 = raw1 * 3.3 / 65535
    print("ADC A1: raw={}, voltage={:.3f}V".format(raw1, voltage1))
    print("PASS: ADC second channel A1")
except Exception as e:
    print("WARN: ADC A1: {}".format(e))
...
try:
    ...
    try:
        ...
        print("SKIP: Internal temp sensor: {}".format(e2))
except Exception as e:
